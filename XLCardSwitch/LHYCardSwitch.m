...
#import "LHYCardSwitch.h"
#import "LHYCardSwitchFlowLayout.h"
#import "LHYCard.h"
...
@interface LHYCardSwitch ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
{
...
{
    LHYCardSwitchFlowLayout *flowLayout = [[LHYCardSwitchFlowLayout alloc] init];
    ...
    [_collectionView registerClass:[LHYCard class] forCellWithReuseIdentifier:@"LHYCard"];
...
-(void)setModels:(NSArray *)models
{
    _models = models;
    if (_models.count) {
        LHYCardModel *model = _models.firstObject;
...
-(void)scrollToCenter
{
    ...
    LHYCardModel *model = _models[_currentIndex];
    _imageView.image = [UIImage imageNamed:model.imageName];
...
{
    static NSString* cellId = @"LHYCard";
    LHYCard* card = [collectionView dequeueReusableCellWithReuseIdentifier:cellId forIndexPath:indexPath];
